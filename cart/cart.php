	...
	<div class="container">
		...
		<div class="shopping-left">
			<!-- <div class="shopping-left-basket">
				<ul>
					<li class="total">Total : <span><?php echo 'Rp '.number_format($total,2,",","."); ?></span></li>
				</ul>
			</div> -->
		
			<div class="shopping-right-basket">
				<a class="btn-continue" href="../index.php">Lanjutkan Belanja</a>
				<!-- <a class="btn-continue" href="../index.php?p=cart&act=clear">Hapus Semua</a> -->
				<a class="btn-continue" href="../index.php?p=checkout">Lanjutkan Pembayaran</a>
				<?php
