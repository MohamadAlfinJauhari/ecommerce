		...
		<form action="../index.php?p=checkout" class="form-horizontal" method="POST">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					...
					<!-- value="<?php echo isset($_POST['name']) ? $_POST['name'] : $data['fullname'];?>"
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					...
					<!-- value="<?php echo isset($_POST['city']) ? $_POST['city'] : $data['city'];?>"
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					...
					<!-- value="<?php echo isset($_POST['state']) ? $_POST['state'] : $data['state'];?>"
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					...
					<!-- value="<?php echo isset($_POST['postcode']) ? $_POST['postcode'] : $data['zip_code'];?>"
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					...
					<!-- value="<?php echo isset($cardnumber) ? $cardnumber : ' ';?>"
