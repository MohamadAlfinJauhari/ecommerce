<div class="container">
	<h1 class="well"><center>Erago</center></h1>
				...
				<div class="col-sm-12">
					...
					<div class="row">
						...
						<div class="col-sm-6 form-group">
							...
							<select name="gender" class="form-control">
								<option value="blank">Pilih jenis</option>
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							<label>Alamat, Provinsi dan Kota :</label>
					...
					<div class="row">
						<div class="col-sm-12 form-group">
							...
							<input type="file" class="form-control" name="photo" maxlength="14" placeholder="Masukan foto pesanan Anda">
							<!-- <span class="text-danger msg-error"><?php echo $phoneErr; ?></span> -->
						</div>
					</div>
